...
export const locations: Record<string, LocationData> = {
  'long-eaton': {
    slug: 'long-eaton',
    name: 'Long Eaton',
    metaTitle: 'Skip Hire Long Eaton | From £120 | No VAT | Local Delivery',
    heroDescription: 'Family-run skip hire serving Long Eaton and surrounding areas. Competitive prices with no VAT on domestic hires. From mini skips to builders skips, we have the right size for your project.',
    areas: ['Sawley', 'Sandiacre', 'Breaston', 'Toton', 'Chilwell', 'Attenborough'],
    postcodes: ['NG10', 'NG9'],
    faqs: [
      { q: 'How much is skip hire in Long Eaton?', a: 'Our skip hire prices in Long Eaton start from £120 for a 2-yard mini skip. As a no-VAT business, you save 20% compared to VAT-registered competitors. Call us for an exact quote.' },
      ...
      { q: 'What skip sizes are available in Long Eaton?', a: 'We offer 2-yard mini skips, 4-yard midi skips, 8-yard builders skips, and 12-yard large skips. We also offer grab hire, wait and load, and rubbish clearance services.' },
    ],
  },
  'nottingham': {
    slug: 'nottingham',
    name: 'Nottingham',
    metaTitle: 'Skip Hire Nottingham | From £120 | No VAT | Reliable Service',
    ...
    faqs: [
      { q: 'How much is skip hire in Nottingham?', a: 'Skip hire in Nottingham starts from £120 for a 2-yard mini skip. We do not charge VAT, saving you 20% compared to most competitors in the Nottingham area.' },
  ...
  'derby': {
    slug: 'derby',
    name: 'Derby',
    metaTitle: 'Skip Hire Derby | From £120 | No VAT | Fast Delivery',
    ...
    faqs: [
      { q: 'How much is skip hire in Derby?', a: 'Our skip hire prices in Derby start from £120 for a 2-yard mini skip with no VAT added. This saves you 20% compared to VAT-registered skip hire companies in the Derby area.' },
