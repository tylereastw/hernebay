...
const skips = [
  {
    name: '5-Yard Skip',
    yards: '5 Cubic Yards',
    description: 'The ideal choice for kitchen or bathroom refits, garden clearances, and medium home projects.',
    capacity: '~40-50 Black Bags',
  ...
  },
  {
    ...
    yards: '12 Cubic Yards',
    description: 'Maximum capacity for major renovations, house clearances, and large construction projects.',
    capacity: '~120 Black Bags',
